...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row mt-6">
                <div class="col-x1-3 col-sm-6 mb-x1-0 ">
                    ...
                    <div class="card my-4 py-4">
                        <div class="card-header p-3 pt-4 py-4">
                            <div
                ...
                <div class="col-lg-5 col-sm-5 mt-sm-0 mt-4">
                    <div class="card my-4 py-4">
                        <div class="card-header p-3 pt-4 bg-transparent">
                            <div
                    ...
                    <div class="card my-4 py-4">
                        <div class="card-header p-3 pt-4 bg-transparent">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">registerd users</p>
                                <h4 class="mb-0">
                                    <?php echo $count; ?>
                                </h4>
                            </div>
